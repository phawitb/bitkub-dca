...
# st.write(get_server_time())
# server_time = get_server_time()
# converted_datetime = datetime.fromtimestamp(server_time/1000)
# st.write(converted_datetime)
...
# df_historys = pd.DataFrame(all_trades)
# df_history_dca = df_historys[df_historys['client_id'] == 'dca']
# df_history_dca['datetime'] = pd.to_datetime(df_history_dca['ts'], unit='ms')  # Specify unit='s' for seconds


# st.write(df_history_dca)
